...
### Input Project Name, Description, Client, Contractor
...
![Upload CSV or input values manually. Text fields are not editable](images/page 2.png)
### Graph and Min/Max values from CSV file
![Graph and Min/Max values from CSV file](images/csv file.png)
### Result Page
